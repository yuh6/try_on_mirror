...
const FALLBACK_PROFILE: ElderProfile = {
  ...
  routine: "每天6:30起床，7点看电视/听收音机；周一上午去菜市场；周二周四下午跟王姨刘姨打牌；周日晚儿子视频通话",
  activities: "",
  hobbies: "看戏曲频道、看天气预报、打牌、织毛衣",
  contact_habit: "",
  personality: "开朗坚强但报喜不报忧，怕麻烦人",
  speech_habits: "",
  call_ai: "像贴心侄女一样唠家常，温暖、有耐心，不急不躁",
  emotion_style: "",
};
...
【开场方式】
电话接通后你先自然地问好（"${title}早啊"/"${title}，吃过饭了没"），然后从档案里挑一件最贴心的健康小事切入，比如：
- 看到档案里有高血压、每天吃降压药 → "今天的降压药吃了吗？"
- 看到膝盖不好 → "今天腿脚舒服吗？膝盖没闹吧？"
每次只问一件，等她回应了再顺着聊。不要一次说一堆，不要念稿。
...
export const OPENING_TRIGGER =
  "（电话刚接通，老人拿起了电话。请你自然地先问好，然后基于档案关心一件她的健康小事，比如降压药或膝盖。一两句就好，像老朋友打电话。）";
